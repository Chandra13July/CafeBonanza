        ...
        <div class="flex flex-col md:flex-row w-full h-full">
            <div class="w-full md:w-3/5 hidden md:flex items-center justify-center">
                <div class="text-center">
                    <img src="<?= BASEURL; ?>/img/auth2.png" alt="Illustration of two people sitting at a table, drinking coffee and talking" class="w-full h-auto" />
                </div>
            </div>
            <div class="w-full md:w-2/5 flex flex-col justify-center px-4 md:px-8 max-w-md mx-auto">
                ...
                <form id="forgot-password-form" action="<?= BASEURL; ?>/auth/btnVerifyEmailAdmin" method="POST" class="flex flex-col gap-4">
                    <div class="w-full">
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-500">
                        Back to <a href="<?= BASEURL; ?>/auth/loginAdmin" class="text-blue-500 hover:underline">Login?</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        window.onload = function() {
            ...
            if (notification) {
                setTimeout(() => {
                    ...
                    window.location.href = "<?= BASEURL; ?>/auth/resetPasswordAdmin";
                }, 2000);
            }
        };
    </script>
