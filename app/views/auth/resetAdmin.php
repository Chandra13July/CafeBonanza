    ...
    <div class="container relative">
        <div class="flex flex-col md:flex-row w-full h-full">
            ...
            <div class="w-full md:w-2/5 flex flex-col justify-center px-4 md:px-8 max-w-md mx-auto">
                ...
                <form id="reset-password-form" action="<?= BASEURL; ?>/auth/btnResetPasswordAdmin" method="POST" class="flex flex-col gap-2.5">
        ...
        window.onload = function() {
            ...
            if (notification) {
                setTimeout(() => {
                    ...
                    window.location.href = "<?= BASEURL; ?>/auth/loginAdmin";
                }, 2000);
            }
        };
