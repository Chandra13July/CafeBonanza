    ...
    <section class="py-12 text-center px-4 md:px-0">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="aspect-w-1 aspect-h-1">
                <img alt="Modern café interior" src="https://storage.googleapis.com/a1aa/image/egw1dIWfRbluY0QIFAqR3dXjCQOGHOKqQxB4IGjNdwWr3otTA.jpg" class="w-full h-full object-cover" />
            </div>
            <div class="aspect-w-1 aspect-h-1">
                <img alt="Modern café interior" src="https://storage.googleapis.com/a1aa/image/egw1dIWfRbluY0QIFAqR3dXjCQOGHOKqQxB4IGjNdwWr3otTA.jpg" class="w-full h-full object-cover" />
            </div>
