        ...
        <div class="container mx-auto px-6 md:px-28">
            ...
            <div class="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
                <div class="md:w-1/2 px-8">
                    <img alt="Cafe Bonanza staff serving customers" class="rounded-lg shadow-lg" height="300" src="https://storage.googleapis.com/a1aa/image/UPOneCyWqm39ZKIbvq9zl0KqLqGqKCAkLZKwDJYvMUrpMY8JA.jpg" width="500" />
                </div>
                <div class="md:w-1/2 px-8">
