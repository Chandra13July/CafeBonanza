    ...
    <section class="bg-white py-16 about-section">
        <div class="container mx-auto flex flex-col md:flex-row items-center px-6 md:px-28">
            ...
            <div class="md:w-1/2 mt-8 md:mt-0 flex justify-start md:justify-end">
                <img alt="Interior of Cafe Bonanza with modern rustic design" class="rounded-lg shadow-lg" height="400" src="https://storage.googleapis.com/a1aa/image/XqGwX6e3GuylV6gHWnf7nU0eoibgtbRogGZy6apQyfhSlBjPB.jpg" width="600" />
            </div>
        </div>
    </section>
    <section class="bg-gray-100 py-16 service-section" id="service-section">
        <div class="container mx-auto text-center px-6 md:px-28">
            ...
            <div class="flex overflow-x-auto space-x-4">
                ...
                <div class="bg-white p-8 shadow-lg min-w-[250px]">
                    <i class="fas fa-chair text-4xl text-gray-600 mb-4">
                    </i>
                    <h3 class="text-xl font-bold mb-2">
                        Cozy Atmosphere
                    </h3>
                ...
                <div class="bg-white p-8 shadow-lg min-w-[250px]">
                    <i class="fas fa-wifi text-4xl text-gray-600 mb-4">
                    </i>
                    <h3 class="text-xl font-bold mb-2">
                        Free WiFi
                    </h3>
                ...
                <div class="bg-white p-8 shadow-lg min-w-[250px]">
                    <i class="fas fa-coffee text-4xl text-gray-600 mb-4">
                    </i>
                    <h3 class="text-xl font-bold mb-2">
                        Quality Coffee
                    </h3>
    ...
    <section class="bg-white py-16">
        <div class="container mx-auto px-6 md:px-28">
            <div class="text-left mb-8">
                <span class="bg-gray-200 text-gray-600 py-1 px-3 rounded-none text-sm md:text-lg">
                    Our Mission
                </span>
            </div>
    ...
    <section class="bg-gray-100 py-16">
        <div class="container mx-auto px-6 md:px-28">
            <div class="text-center mb-8">
                <span class="bg-gray-300 text-gray-600 py-1 px-3 rounded-full text-sm">
                    Our Vision
                </span>
            </div>
            ...
            <div class="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
                <div class="md:w-1/2 px-8">
                    <img alt="Cafe Bonanza staff serving customers" class="rounded-lg shadow-lg" height="400" src="https://storage.googleapis.com/a1aa/image/UPOneCyWqm39ZKIbvq9zl0KqLqGqKCAkLZKwDJYvMUrpMY8JA.jpg" width="600" />
                </div>
                <div class="md:w-1/2 px-8">
